...
// The original vertex mod behavior
...
// Added 'stem height' support
void VertexMod_2_half(half4 worldPos, half4 originWp, half speed, half amount, half dst, half zmotion, half zmotionSpeed, half originWeight, half stemHeight, half interaction, half time, out half4 output)
{
	half _DistanceFromOrigin = distance(originWp.y, worldPos.y);

	//stem
	_DistanceFromOrigin = clamp(_DistanceFromOrigin - stemHeight, 0, _DistanceFromOrigin);
